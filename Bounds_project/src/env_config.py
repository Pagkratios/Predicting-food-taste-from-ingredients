#!/usr/bin/env python3
"""Environment-backed dataset path resolution for the bounds pipeline."""
...
def get_raw_recipes_path() -> str:
    """Return the active raw recipe module path, matching the Lasso pipeline."""
